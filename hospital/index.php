...
<head>
    ...
    <title> Qure - Doctor Appointment System </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      <header id="menu-jk">
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">Qure
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="2000">
        ...
        <div class="carousel-item active">
                <img class="d-block w-100" src="assets/images/slider/H4.jpg" alt="First slide" style="max-width: 100%; height: auto;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
            </div>
            
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/slider/gallary02.jpg" alt="Second slide" style="max-width: 100%; height: auto;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/slider/gallary03.jpg" alt="Third slide" style="max-width: 100%; height: auto;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/slider/gallary04.jpg" alt="Fourth slide" style="max-width: 100%; height: 90vh;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/slider/gallary05.jpg" alt="Fifth slide" style="max-width: 100%; height: auto;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/slider/gallary06.jpg" alt="Sixth slide" style="max-width: 100%; height: auto;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/slider/gallary07.jpg" alt="Seventh slide" style="max-width: 100%; height: auto;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/slider/gallary08.jpg" alt="Eighth slide" style="max-width: 100%; height: auto;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/slider/gallary09.jpg" alt="Ninth slide" style="max-width: 100%; height: auto;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/slider/gallary10.jpg" alt="Tenth slide" style="max-width: 100%; height: auto;">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Qure - Doctor Appointment System</h5>
                </div>
...
?>
    ...
    width: 25%; /* Each gallery item takes up 25% of the container width */
    float: left; /* Float left to arrange items horizontally */
    padding: 10px; /* Add some padding around the items */
}

@media (max-width: 768px) {
    .gallery_product {
        width: 50%; /* Change to 50% width for smaller screens */
    }
}

@media (max-width: 480px) {
    .gallery_product {
        width: 100%; /* Change to 100% width for even smaller screens */
    }
}

.gallery_product img {
    /* Styles for the images inside the gallery items */
...
?>
   ...
   <div class="copy" style="text-align: right; font-family: 'Times New Roman', Times, serif;">
    <div class="container">
       <b> Qure - Doctor Appointment System | It's Me </b>            
    </div>
</div>
